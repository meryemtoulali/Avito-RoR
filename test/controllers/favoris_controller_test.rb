...
class FavorisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favori" do
    assert_difference('Favori.count') do
      post favoris_url, params: { favori: { annone_id: @favori.annone_id, utilisateur_id: @favori.utilisateur_id } }
    end
  ...
  test "should update favori" do
    patch favori_url(@favori), params: { favori: { annone_id: @favori.annone_id, utilisateur_id: @favori.utilisateur_id } }
